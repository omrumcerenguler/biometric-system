...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const username = localStorage.getItem("bankUsername") || "User";
  const role = localStorage.getItem("bankRole") || "user";
  ...
  if (welcomeText) {
    welcomeText.textContent = `Welcome ${username}. You can manage your biometric enrollment and verification from this banking portal.`;
  }
  ...
  getBiometricStatus()
    ...
    .catch((error) => {
      console.error("[BANK BIOMETRIC STATUS ERROR]", error);
